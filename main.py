...
def main():
    ...
    btn_del_tab_3 = Button(tab_3, text="Очистить", command=delete_lab_3)
    btn_tab_3 = Button(tab_3, text="Выполнить", foreground="black", background="#199917", command=draw_lab_3)
    ...
    btn_del_tab_5 = Button(tab_5, text="Очистить", command=delete_lab_5)
    btn_tab_5 = Button(tab_5, text="Выполнить", foreground="black", background="#199917", command=draw_lab_5)
